...
import { isEqual, sleep, getRandInt } from "../../../utils/helper";
import { destroyWall } from "../../../utils/destryWall";
...
export const binaryTree = async (
    ...
    await sleep(MAX_ROW * MAX_col); // Wait for the wall setup to complete
